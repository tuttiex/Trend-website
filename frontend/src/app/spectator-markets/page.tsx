                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div>
                            <h1 className="text-4xl lg:text-5xl font-black uppercase tracking-tight mb-2">
                                <span className="text-white">SPECTATOR</span> <span className="bg-gradient-to-br from-primary to-primary-container text-transparent bg-clip-text inline-block animate-kinetic-glow">MARKET</span>
                            </h1>
