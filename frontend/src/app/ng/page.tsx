        ...
        <main className="max-w-7xl mx-auto px-4 py-12">
            ...
            <header className="mb-16 text-center">
                <h1 className={`text-[4rem] md:text-[6rem] font-black mb-4 tracking-tighter leading-none ${spriteGraffiti.className}`}>
                    <span style={{ color: '#b21a1a' }}>NG</span>
                        ...
                        >
                            <Link href={`/token/${token.token_address}`}>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <button className="w-full py-4 bg-[#b21a1a] text-white font-black rounded-xl hover:bg-black hover:text-white transition-colors flex items-center justify-center gap-2">
                                        Trade Now
